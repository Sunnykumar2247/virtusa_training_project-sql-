...
--    3. Core Business Queries
--    4. Advanced Analytics
--    5. Bonus: Indexes & Lost-in-Transit Detection
...
-- ---------------------------------
-- Table 1: Partners
-- Stores delivery partner companies
-- ---------------------------------
...
-- ---------------------------------
-- Table 2: Shipments
-- Each row = one package in the system
-- ---------------------------------
CREATE TABLE Shipments (
    ...
    ActualDeliveryDate  DATE,           -- NULL = not yet delivered
    Status              VARCHAR(30)     NOT NULL DEFAULT 'In Transit',
                        -- Possible: 'Delivered', 'In Transit',
                        --           'Returned', 'Lost', 'Pending'
...
-- ---------------------------------
-- Table 3: DeliveryLogs
-- Tracks every status update for a shipment
-- ---------------------------------
...
('SS-2024-00020', 2,  'Bangalore',  'Mysore',       2.10, '2024-06-20', '2024-06-22', '2024-06-22', 'Delivered');
                            ...
                            -- Insert DeliveryLogs (25 records)
...
-- ============================================================
-- HOW IT WORKS:
--   We compare ActualDeliveryDate with PromisedDate.
--   If actual > promised → the shipment is delayed.
--   We also show HOW MANY DAYS it was delayed using DATEDIFF.
-- ============================================================
...
-- ============================================================
-- HOW IT WORKS:
--   GROUP BY partner → count total shipments.
--   Use SUM with CASE to count only 'Delivered' rows → successful deliveries.
--   Divide delivered/total × 100 → Success Rate percentage.
--   LEFT JOIN ensures partners with 0 shipments still appear.
-- ============================================================
...
-- ============================================================
-- HOW IT WORKS:
--   Calculate delay for each delivered shipment.
--   Negative delay means early delivery (good).
--   Average the delay per partner → rank ascending.
-- ============================================================
...
-- ============================================================
-- HOW IT WORKS:
--   Filter ShipmentDate to the last 30 days from today.
--   Count shipments per destination city.
--   Sort descending → top city is at the top.
-- ============================================================
...
-- ============================================================
-- HOW IT WORKS:
--   CTE (LatestLog) finds the most recent log per shipment.
--   Main query joins shipments + partners + that latest log.
--   This avoids subquery repetition and is easy to read.
-- ============================================================
...
-- ---------------------------------
-- HOW IT WORKS:
--   Find shipments whose latest DeliveryLog entry is older
--   than 7 days, and whose Status is still active (not Delivered/Returned).
--   These are "potentially lost" packages.
-- ---------------------------------
